...
def make_exe():
    ...
    python_config.run_command = "from mimeogram import main; main()"
    ...
    # Add bundle introspection capabilities.
    exe.add_python_resources(exe.pip_install(["oxidized-importer"]))
